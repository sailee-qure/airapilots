  ...
  <section class="site site-enugu" id="s-enugu">
    ...
    <div class="site-hero">
      ...
      <div class="site-hero-info">
        <dl>
          ...
          <dt>Status</dt><dd>Live since late March 2026</dd>
        </dl>
      </div>
    </div>
    ...
    <div class="barchart" style="margin-top: 28px;">
      <div class="bar-row">
        ...
        <div class="bar-track">
          <div class="seg seg-1" style="width: 43%">43%</div>
          <div class="seg seg-2" style="width: 30%">30%</div>
          <div class="seg seg-3" style="width: 27%">27%</div>
        </div>
        <div class="bar-total">5.9 min</div>
      </div>
      <div class="bar-row">
        <div class="bar-label">Expected<br>with Aira</div>
        <div class="bar-track target">
          <div class="seg seg-1" style="width: 90%">90%</div>
          <div class="seg seg-2" style="width: 5%">5%</div>
          <div class="seg seg-3" style="width: 5%">&lt;5%</div>
        </div>
        <div class="bar-total">target</div>
      </div>
    </div>
    <div class="legend">
    ...
    <div class="site-hero">
      ...
      <div class="site-hero-info">
        <dl>
          ...
          <dt>Status</dt><dd>Live since March 2026</dd>
        </dl>
      </div>
    </div>
    ...
    <div class="site-hero">
      ...
      <div class="site-hero-info">
        <dl>
          ...
          <dt>Status</dt><dd>Live since April 2026</dd>
        </dl>
      </div>
    </div>
